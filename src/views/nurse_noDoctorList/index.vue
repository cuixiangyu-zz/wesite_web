<template>
  <div v-if="tableData" class="main">
    ...
    <el-form :inline="true">
      ...
      <el-form-item>
        <el-button type="primary" @click="getNoDoctorList">查询</el-button>
      </el-form-item>
      <el-form-item style="margin-left: 50px;">
        <el-button v-if="checkBoxVisible" type="primary" @click="batchEdit">批量转诊</el-button>
      </el-form-item>
    </el-form>

    <!-- 用户数据表格 -->
    <el-table :data="tableData.list" border style="width: 100%" @selection-change="changeFun">
      <el-table-column v-if="true" type="selection" prop="checked" label="批量转诊" align="center" />
...
import { getNoDoctorList, batchEdit, getSignDoctor } from '@/api/nurseNoDoctorList'
export default {
  data() {
    return {
      name: '',
  ...
  methods: {
    getNoDoctorList() {
      getNoDoctorList(this.defaltQuery).then(res => {
