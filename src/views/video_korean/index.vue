...
<script>
    ...
    export default {
        ...
        beforeRouteLeave(to, form, next) {
            ...
            sessionStorage.setItem("refresh_korean", true);
            sessionStorage.setItem("videoAndIdList", JSON.stringify(this.videoAndIdList));
            next();
        },
        methods: {
            getPageList() {
                var listQuery = sessionStorage.getItem("listQuery_korean");
                var refresh = sessionStorage.getItem("refresh_korean");

                if (listQuery !== null && refresh !== null && refresh === "true") {
                    this.listQuery = JSON.parse(listQuery);
                    sessionStorage.setItem("refresh_korean", false);
                }
                if (
